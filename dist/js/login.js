...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/js/client/login.js");
/******/ })
/************************************************************************/
/******/ ({
...
var debug = __webpack_require__(/*! debug */ "./node_modules/follow-redirects/node_modules/debug/src/browser.js")("follow-redirects");
...
var Login = function (_React$Component) {
    ...
    _createClass(Login, [{
        ...
        value: function render() {
            ...
            var top = process.platform == 'win32' ? '30px' : '60px';
            return _react2.default.createElement(
                'div',
                { className: 'container-fluid login' },
                _react2.default.createElement(
                    'div',
                    { className: 'text-center logo', style: { paddingTop: top } },
...
var API = function () {
    function API() {
        ...
        _axios2.default.defaults.baseURL = 'https://edu.xuancai365.com/api/' + "teacher";
    ...
    _createClass(API, [{
        ...
        value: function getAuthHeader() {
            ...
            if (auth_token) {
                _axios2.default.defaults.headers.common['Authorization'] = 'Bearer ' + auth_token;
            }
        }
    }, {
        key: 'get',
